...
# type: "transparency" → 0-100 slider
...
SCHEMA = {
    ...
    "Slides": {
        ...
        "fields": [
            ...
            {"key": "transparency.header_band_alpha",       "label": "Độ trong suốt Header (%)",       "type": "transparency"},
            ...
            {"key": "slide.bg_transparency",                "label": "Độ trong suốt nền slide (%)",    "type": "transparency"},
        ]
    },
    "Panels": {
        "_key": None,
